...
export const settings: any = {
  ...
  chainConfig: {
    10143: {
      ...
      balancegetter:
        '0x210C202dD0eC97E70BB11e4992d72902B484C3e6' as `0x${string}`,
      router: '0x1F3815171F6108936E512c8eB67EF0441C550bb6' as `0x${string}`,
      referralManager: '0x210C202dD0eC97E70BB11e4992d72902B484C3e6' as `0x${string}`,
      launchpadRouter: '0x1F3815171F6108936E512c8eB67EF0441C550bb6' as `0x${string}`,
      crystalVaults: "0x03488af621dc994A0119C81Bdcef0968389058c5" as `0x${string}`,
      ...
      markets: {
        MONUSDC: {
          ...
          address: '0xCFDf9007A1C66009d89cAAaE9F9848C5101618bd'.toLowerCase(),
          latestPrice: 39.283,
          marketType: 2,
          precision: 5,
        ...
        sMONMON: {
          ...
          baseDecimals: BigInt(18),
          address: '0x8b175dA8D754e657D5c96E71F5E7c264f1Be85dB'.toLowerCase(),
        ...
        aprMONMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x5Ef165c8AB4056F77Ed03a5Bb3Ceb4B0919F3e97'.toLowerCase(),
          scaleFactor: BigInt(10 ** 4),
          priceFactor: BigInt(10000),
          tickSize: BigInt(1),
          minSize: BigInt(100000000000000000),
        ...
        shMONMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x102e3011910EDCcE50eB2483088ac6Fd7E85A286'.toLowerCase(),
          scaleFactor: BigInt(10 ** 4),
          priceFactor: BigInt(10000),
          tickSize: BigInt(1),
          minSize: BigInt(100000000000000000),
        ...
        DAKMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x8B8bf7f278A376c9B26d8793b87F45BD921d99B5'.toLowerCase(),
          scaleFactor: BigInt(10 ** 4),
          priceFactor: BigInt(10000),
          tickSize: BigInt(1),
          minSize: BigInt(100000000000000000),
        ...
        CHOGMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x4e3D3a8bdcD615dA9394De2Dd852E02fb1D95B34'.toLowerCase(),
        ...
        YAKIMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x4dDC7c24476bdbF983c7bAe1c54B83AaF7cc6257'.toLowerCase(),
        ...
        WETHUSDC: {
          ...
          quoteDecimals: BigInt(6),
          baseDecimals: BigInt(18),
          address: '0xFBB6Bf181262800F4eaEC870b7c9b391d20C762B'.toLowerCase(),
          marketType: 0,
        ...
        WBTCUSDC: {
          ...
          address: '0x2E1f23AABa88A4d89d8F97D4F9D485813681C24d'.toLowerCase(),
        ...
        WSOLUSDC: {
          ...
          address: '0x25C8009dDFa308D12a213f45Cd9767036b0CefA6'.toLowerCase(),
          scaleFactor: BigInt(10 ** 5),
        ...
        USDTUSDC: {
          ...
          address: '0xB1BB300b8e91Fb8E22eC0f6134c305e1925AC3D5'.toLowerCase(),
      ...
      addresstomarket: Object.fromEntries([
        ['0xCFDf9007A1C66009d89cAAaE9F9848C5101618bd', 'MONUSDC'],
        ['0x8b175dA8D754e657D5c96E71F5E7c264f1Be85dB', 'sMONMON'],
        ['0x5Ef165c8AB4056F77Ed03a5Bb3Ceb4B0919F3e97', 'aprMONMON'],
        ['0x102e3011910EDCcE50eB2483088ac6Fd7E85A286', 'shMONMON'],
        ['0x8B8bf7f278A376c9B26d8793b87F45BD921d99B5', 'DAKMON'],
        ['0x4e3D3a8bdcD615dA9394De2Dd852E02fb1D95B34', 'CHOGMON'],
        ['0x4dDC7c24476bdbF983c7bAe1c54B83AaF7cc6257', 'YAKIMON'],
        ['0xFBB6Bf181262800F4eaEC870b7c9b391d20C762B', 'WETHUSDC'],
        ['0x2E1f23AABa88A4d89d8F97D4F9D485813681C24d', 'WBTCUSDC'],
        ['0x25C8009dDFa308D12a213f45Cd9767036b0CefA6', 'WSOLUSDC'],
        ['0xB1BB300b8e91Fb8E22eC0f6134c305e1925AC3D5', 'USDTUSDC'],
