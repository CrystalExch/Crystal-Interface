...
export const settings: any = {
  ...
  chainConfig: {
    10143: {
      ...
      balancegetter:
        '0xFF685665be712475e8d582ABE7c73D8Db19cc05B' as `0x${string}`,
      router: '0x88E574535dB028329eFa7789cfe1217653F0C698' as `0x${string}`,
      referralManager: '0xFF685665be712475e8d582ABE7c73D8Db19cc05B' as `0x${string}`,
      launchpadRouter: '0x88E574535dB028329eFa7789cfe1217653F0C698' as `0x${string}`,
      crystalVaults: "0x5B9C1f2D9230Fe5d118fc80cf02410EF3465d67E" as `0x${string}`,
      ...
      markets: {
        MONUSDC: {
          ...
          address: '0xB39bda9358cDAdBA68Bb01d358D376FbB19d4A85'.toLowerCase(),
          marketType: 2,
          precision: 5,
        ...
        sMONMON: {
          ...
          baseDecimals: BigInt(18),
          address: '0xB2e5AA6d1dA5F91004a4579CABd311089D3804d3'.toLowerCase(),
        ...
        aprMONMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x827dB93d544A1DF381dCA14F52Aa72651aBb422C'.toLowerCase(),
          scaleFactor: BigInt(10 ** 4),
          priceFactor: BigInt(10000),
          tickSize: BigInt(1),
          minSize: BigInt(100000000000000000),
        ...
        shMONMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x396704cb4C7114b0F4638ab1E9Ec4894E3AF7174'.toLowerCase(),
          scaleFactor: BigInt(10 ** 4),
          priceFactor: BigInt(10000),
          tickSize: BigInt(1),
          minSize: BigInt(100000000000000000),
        ...
        DAKMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x6AA8BDfD9E975772B5636eE3A95E67aD6cDAE79C'.toLowerCase(),
        ...
        CHOGMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0xBc8372B471DFDbD5FBC4755d70CeCD7A182aB872'.toLowerCase(),
          scaleFactor: BigInt(10 ** 9),
          priceFactor: BigInt(1000000000),
          tickSize: BigInt(1),
          minSize: BigInt(100000000000000000),
        ...
        YAKIMON: {
          ...
          quoteDecimals: BigInt(18),
          baseDecimals: BigInt(18),
          address: '0x1c5c8F377Ae1fAc282989Ae2D18af3d7083a0971'.toLowerCase(),
          scaleFactor: BigInt(10 ** 9),
          priceFactor: BigInt(1000000000),
          tickSize: BigInt(1),
          minSize: BigInt(100000000000000000),
        ...
        WETHUSDC: {
          ...
          quoteDecimals: BigInt(6),
          baseDecimals: BigInt(18),
          address: '0xdAfa99D4232f77907b2d4263738e0d723A584C3e'.toLowerCase(),
          marketType: 0,
        ...
        WBTCUSDC: {
          ...
          address: '0xD4F753216e9d75409FE21e8fb899C7b7b0446d7d'.toLowerCase(),
        ...
        WSOLUSDC: {
          ...
          address: '0x2797e58612A8c1B037629c29D1b9BFb126C80C96'.toLowerCase(),
        ...
        USDTUSDC: {
          ...
          address: '0x554f6408be2C73f66cF5a7C46f47A4b4CD3c18b6'.toLowerCase(),
      ...
      addresstomarket: Object.fromEntries([
        ['0xff304554508f088E228deBF7B166c953114abe50', 'MONUSDC'],
        ['0xB2e5AA6d1dA5F91004a4579CABd311089D3804d3', 'sMONMON'],
        ['0x827dB93d544A1DF381dCA14F52Aa72651aBb422C', 'aprMONMON'],
        ['0x396704cb4C7114b0F4638ab1E9Ec4894E3AF7174', 'shMONMON'],
        ['0x6AA8BDfD9E975772B5636eE3A95E67aD6cDAE79C', 'DAKMON'],
        ['0xBc8372B471DFDbD5FBC4755d70CeCD7A182aB872', 'CHOGMON'],
        ['0x1c5c8F377Ae1fAc282989Ae2D18af3d7083a0971', 'YAKIMON'],
        ['0xdAfa99D4232f77907b2d4263738e0d723A584C3e', 'WETHUSDC'],
        ['0xD4F753216e9d75409FE21e8fb899C7b7b0446d7d', 'WBTCUSDC'],
        ['0x2797e58612A8c1B037629c29D1b9BFb126C80C96', 'WSOLUSDC'],
        ['0x554f6408be2C73f66cF5a7C46f47A4b4CD3c18b6', 'USDTUSDC'],
