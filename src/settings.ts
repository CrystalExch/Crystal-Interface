...
export const settings: any = {
  ...
  chainConfig: {
    10143: {
      ...
      balancegetter:
        '0x7e63280889c9077277475dd3Ec7397a8d41Bfe5a' as `0x${string}`,
      router: '0x0c38F3721dc01A804065423b43a3c61b32353377' as `0x${string}`,
      referralManager: '0x7e63280889c9077277475dd3Ec7397a8d41Bfe5a' as `0x${string}`,
      launchpadRouter: '0x0c38F3721dc01A804065423b43a3c61b32353377' as `0x${string}`,
      crystalVaults: "0x327603aa3D3d601B53cBe07CFdc0555E85E60E7C" as `0x${string}`,
      ...
      markets: {
        MONUSDC: {
          ...
          address: '0x62E5b8449dB48C0897e46Fd37dADCA06c37F440B'.toLowerCase(),
          marketType: 2,
          precision: 5,
        ...
        WBTCUSDC: {
          ...
          address: '0xDbbcef0ddEBF99E2dDE5b78129eE69eDF940c754'.toLowerCase(),
      ...
      addresstomarket: Object.fromEntries([
        ['0x8e8fe6f37d4cf695b275d7b48efb4187160687ed', 'MONUSDC'],
        ...
        ['0xDbbcef0ddEBF99E2dDE5b78129eE69eDF940c754', 'WBTCUSDC'],
