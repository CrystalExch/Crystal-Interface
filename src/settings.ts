...
export const settings: any = {
  ...
  chainConfig: {
    ...
    143: {
      ...
      nadFunBondingCurve: '0x7193E46d4a812c8990F96A6E9c1f1ed338b2a6b7' as `0x${string}`,
      nadFunRouter: '0x84202FD46851B4a9Da9Ab3100Dd459Bf1F0a3dC0' as `0x${string}`,
      nadFunDexRouter: '0x2b1d8Bb0dED32dd1C4D4B04B4B3829ddA9aecC65' as `0x${string}`,
