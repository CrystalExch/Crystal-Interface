...
type TradeStatus = 'new' | 'graduating' | 'graduated';

const [activePresets, setActivePresets] = useState<Record<TradeStatus, number>>(() => ({
...
const handleTradeQuickBuy = useCallback(
  ...
  return (
    <div className="tracker-container" style={{
      ...
      <div className="tracker-filters-header">
      ...
      <div className="wtw-content">
        {activeTab === 'wallets' && (
          <div className="tracker-wallet-manager">
            <div style={{ minWidth: '450px', display: 'flex', height: '100%', flexDirection: 'column' }}>
  ...
  <span className="wtw-wallet-emoji-avatar">{wallet.emoji}</span>
                      ...
                      <div className="wtw-wallet-actions">
                        ...
                        <Tooltip content="Scan Address">
                          ...
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="wtw-action-icon">
