    ...
    return new SignableOrder(
      {
        orderType,
        nonce,
        quantumsAmountSynthetic: order.quantumsAmountSynthetic,
        quantumsAmountCollateral: order.quantumsAmountCollateral,
        quantumsAmountFee: order.quantumsAmountFee,
        assetIdSynthetic: order.assetIdSynthetic,
        assetIdCollateral: order.assetIdCollateral,
        assetIdFee: order.assetIdCollateral,
        positionId,
        isBuyingSynthetic: order.isBuyingSynthetic,
