...
import { COLLATERAL_ASSET, COLLATERAL_ASSET_ID_BY_NETWORK_ID } from '../constant';
...
export class SignableWithdrawal extends StarkSignable {
  static fromWithdrawalWithClientId(withdrawal, networkId, assetId) {
  ...
  static fromWithdrawalWithNonce(withdrawal, networkId, assetId) {
    ...
    quantumsAmount = withdrawal.humanAmount
      ? new BigNumber(withdrawal.humanAmount)
