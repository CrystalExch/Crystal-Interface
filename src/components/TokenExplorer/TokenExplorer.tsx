    ...
    <div className="display-dropdown" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="display-dropdown-content">
          <div className="display-dropdown-header">
            <h3 className="display-dropdown-title">Display</h3>
            <button
          ...
          <div className="display-content">
              ...
              <div>
                <div className="display-toggles">
                  <div className="toggle-item">
                    ...
                    <div
                      className={`toggle-switch ${settings.hideSearchBar ? 'active' : ''}`}
                      onClick={() => updateSetting('hideSearchBar', !settings.hideSearchBar)}
                    >
                      <div className="toggle-slider" />
                    </div>
                  </div>
                  ...
                  <div className="toggle-item">
                    ...
                    <div
                      ...
                      onClick={() => updateSetting('noDecimals', !settings.noDecimals)}
                    >
                      <div className="toggle-slider" />
                    </div>
                  </div>
                  ...
                  <div className="toggle-item">
                    ...
                    <div
                      ...
                      onClick={() => updateSetting('hideHiddenTokens', !settings.hideHiddenTokens)}
                    >
                      <div className="toggle-slider" />
                    </div>
                  </div>
                  ...
                  <div className="toggle-item">
                    ...
                    <div
                      ...
                      onClick={() => updateSetting('squareImages', !settings.squareImages)}
                    >
                      <div className="toggle-slider" />
                    </div>
                  </div>
                  ...
                  <div className="toggle-item">
                    ...
                    <div
                      ...
                      onClick={() => updateSetting('progressBar', !settings.progressBar)}
                    >
                      <div className="toggle-slider" />
                    </div>
                  </div>
                  ...
                  <div className="toggle-item">
                    ...
                    <div
                      className={`toggle-switch ${settings.spacedTables ? 'active' : ''}`}
                      onClick={() => updateSetting('spacedTables', !settings.spacedTables)}
                    >
                      <div className="toggle-slider" />
                    </div>
                  </div>
              ...
              <div>
                <div className="display-section">
                  ...
                  <div className="metrics-size-options">
                    <button
                      className={`size-option ${settings.metricSize === 'small' ? 'active' : ''}`}
                      onClick={() => updateSetting('metricSize', 'small')}
                    >
                      MC 77K<br />Small
                    </button>
                    <button
                      className={`size-option ${settings.metricSize === 'large' ? 'active' : ''}`}
                ...
                <div className="display-section">
                  ...
                  <div className="quickbuy-size-options">
                    ...
                    >
                      <div className="quickbuy-diamond" />
                      Small
                    </button>
                    <button
            ...
            {activeTab === 'row' && (
              <div className="customize-section">
                ...
                <div className="row-toggles">
                  <div
                    className={`row-toggle ${settings.visibleRows.marketCap ? 'active' : ''}`}
                    onClick={() => updateRowSetting('marketCap', !settings.visibleRows.marketCap)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.marketCap}
                      readOnly
                    />
                    <span className="row-toggle-label">Market Cap</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.volume ? 'active' : ''}`}
                    onClick={() => updateRowSetting('volume', !settings.visibleRows.volume)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.volume}
                      readOnly
                    />
                    <span className="row-toggle-label">Volume</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.fees ? 'active' : ''}`}
                    onClick={() => updateRowSetting('fees', !settings.visibleRows.fees)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.fees}
                      readOnly
                    />
                    <span className="row-toggle-label">Fees</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.tx ? 'active' : ''}`}
                    onClick={() => updateRowSetting('tx', !settings.visibleRows.tx)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.tx}
                      readOnly
                    />
                    <span className="row-toggle-label">TX</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.socials ? 'active' : ''}`}
                    onClick={() => updateRowSetting('socials', !settings.visibleRows.socials)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.socials}
                      readOnly
                    />
                    <span className="row-toggle-label">Socials</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.holders ? 'active' : ''}`}
                    onClick={() => updateRowSetting('holders', !settings.visibleRows.holders)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.holders}
                      readOnly
                    />
                    <span className="row-toggle-label">Holders</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.proTraders ? 'active' : ''}`}
                    onClick={() => updateRowSetting('proTraders', !settings.visibleRows.proTraders)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.proTraders}
                      readOnly
                    />
                    <span className="row-toggle-label">Pro Traders</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.kols ? 'active' : ''}`}
                    onClick={() => updateRowSetting('kols', !settings.visibleRows.kols)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.kols}
                      readOnly
                    />
                    <span className="row-toggle-label">KOLs</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.devMigrations ? 'active' : ''}`}
                    onClick={() => updateRowSetting('devMigrations', !settings.visibleRows.devMigrations)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.devMigrations}
                      readOnly
                    />
                    <span className="row-toggle-label">Dev Migrations</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.top10Holders ? 'active' : ''}`}
                    onClick={() => updateRowSetting('top10Holders', !settings.visibleRows.top10Holders)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.top10Holders}
                      readOnly
                    />
                    <span className="row-toggle-label">Top 10 Holders</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.devHolding ? 'active' : ''}`}
                    onClick={() => updateRowSetting('devHolding', !settings.visibleRows.devHolding)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.devHolding}
                      readOnly
                    />
                    <span className="row-toggle-label">Dev Holding</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.fundingTime ? 'active' : ''}`}
                    onClick={() => updateRowSetting('fundingTime', !settings.visibleRows.fundingTime)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.fundingTime}
                      readOnly
                    />
                    <span className="row-toggle-label">Funding Time</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.snipers ? 'active' : ''}`}
                    onClick={() => updateRowSetting('snipers', !settings.visibleRows.snipers)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.snipers}
                      readOnly
                    />
                    <span className="row-toggle-label">Snipers</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.insiders ? 'active' : ''}`}
                    onClick={() => updateRowSetting('insiders', !settings.visibleRows.insiders)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.insiders}
                      readOnly
                    />
                    <span className="row-toggle-label">Insiders</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.bundlers ? 'active' : ''}`}
                    onClick={() => updateRowSetting('bundlers', !settings.visibleRows.bundlers)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.bundlers}
                      readOnly
                    />
                    <span className="row-toggle-label">Bundlers</span>
                  </div>

                  <div
                    className={`row-toggle ${settings.visibleRows.dexPaid ? 'active' : ''}`}
                    onClick={() => updateRowSetting('dexPaid', !settings.visibleRows.dexPaid)}
                  >
                    <input
                      type="checkbox"
                      className="row-toggle-checkbox"
                      checked={settings.visibleRows.dexPaid}
                      readOnly
                    />
                    <span className="row-toggle-label">Dex Paid</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === 'extras' && (
              <div>
                <div className="display-section">
                  <h4 className="display-section-title">Additional Options</h4>
    ...
    >
      ...
      <div className="explorer-token-left">
        ...
        >
          ...
          {hoveredImage === token.id && positionCalculated && createPortal(
            <div
              className={`explorer-image-preview ${showPreview ? 'show' : ''} placement-${previewPosition.placement}`}
              style={{
                position: 'absolute',
            ...
            >
              <div className="explorer-preview-content">
                <img
                  ...
                  className="explorer-preview-image"
                />
                <div className="explorer-camera-preview-text">
                  <span className="explorer-token-ticker-preview">{token.symbol}</span>
                  <span className="explorer-token-name-preview">{token.name}</span>
                </div>
              </div>
            </div>,
            document.body
            ...
            <Tooltip content="Sniper Holding">
              <div className="explorer-holding-item">
                ...
                <span
                  ...
                  style={{ color: token.sniperHolding > 5 ? "#eb7070ff" : "rgb(67, 254, 154)" }}
                >
          ...
          {displaySettings.visibleRows.devHolding && (
            <Tooltip content="Developer Holding">
              <div className="explorer-holding-item">
                ...
                <span
                  className="explorer-holding-value"
                  style={{ color: token.devHolding > 5 ? "#eb7070ff" : "rgb(67, 254, 154)" }}
                >
          ...
          {displaySettings.visibleRows.bundlers && (
            <Tooltip content="Bundle Holding">
              <div className="explorer-holding-item">
                ...
                <span
                  className="explorer-holding-value"
                  style={{ color: token.bundleHolding > 5 ? "#eb7070ff" : "rgb(67, 254, 154)" }}
                >
          ...
          {displaySettings.visibleRows.insiders && (
            <Tooltip content="Insider Holding">
              <div className="explorer-holding-item">
                ...
                <span
                  className="explorer-holding-value"
                  style={{ color: token.insiderHolding > 5 ? "#eb7070ff" : "rgb(67, 254, 154)" }}
                >
          ...
          {displaySettings.visibleRows.top10Holders && (
            <Tooltip content="Top 10 holders percentage">
              <div className="explorer-holding-item">
                ...
                <span
                  className="explorer-holding-value"
                  style={{ color: token.top10Holding > 5 ? "#eb7070ff" : "rgb(67, 254, 154)" }}
                >
...
const setActivePreset = useCallback((status: Token['status'], preset: number) => {
  ...
  // Updated copyToClipboard with popup notification
  const copyToClipboard = useCallback(async (text: string) => {
    ...
    try {
      ...
      if (showLoadingPopup && updatePopup) {
        ...
        // Immediately update to success state
        setTimeout(() => {
          updatePopup(txId, {
            title: 'Address Copied',
            subtitle: `${text.slice(0, 6)}...${text.slice(-4)} copied to clipboard`,
  ...
  // Updated handleQuickBuy with popup notifications
...
<div className="explorer-column-title-right">
  ...
  <div className="explorer-quickbuy-container">
    ...
    <button
      className={`explorer-preset-pill ${activePresets.new === 1 ? 'active' : ''}`}
      onClick={() => setActivePreset('new', 1)}
    >
      P1
    </button>
    <button
      className={`explorer-preset-pill ${activePresets.new === 2 ? 'active' : ''}`}
      onClick={() => setActivePreset('new', 2)}
    >
      P2
    </button>
    <button
      className={`explorer-preset-pill ${activePresets.new === 3 ? 'active' : ''}`}
      onClick={() => setActivePreset('new', 3)}
    >
      P3
    </button>
  </div>
...
<div className="explorer-column-title-right">
  ...
  <div className="explorer-quickbuy-container">
    ...
    <img className="quickbuy-monad-icon" src={monadicon} />
      <div className="explorer-preset-controls">
    <button
      className={`explorer-preset-pill ${activePresets.graduating === 1 ? 'active' : ''}`}
      onClick={() => setActivePreset('graduating', 1)}
    >
      P1
    </button>
    <button
      className={`explorer-preset-pill ${activePresets.graduating === 2 ? 'active' : ''}`}
      onClick={() => setActivePreset('graduating', 2)}
    >
      P2
    </button>
    <button
      className={`explorer-preset-pill ${activePresets.graduating === 3 ? 'active' : ''}`}
      onClick={() => setActivePreset('graduating', 3)}
    >
      P3
    </button>
  </div>
...
<div className="explorer-column-title-right">
  ...
  <div className="explorer-quickbuy-container">
    ...
    <img className="quickbuy-monad-icon" src={monadicon} />
      <div className="explorer-preset-controls">
    <button
      className={`explorer-preset-pill ${activePresets.graduated === 1 ? 'active' : ''}`}
      onClick={() => setActivePreset('graduated', 1)}
    >
      P1
    </button>
    <button
      className={`explorer-preset-pill ${activePresets.graduated === 2 ? 'active' : ''}`}
      onClick={() => setActivePreset('graduated', 2)}
    >
      P2
    </button>
    <button
      className={`explorer-preset-pill ${activePresets.graduated === 3 ? 'active' : ''}`}
      onClick={() => setActivePreset('graduated', 3)}
    >
      P3
    </button>
  </div>
