...
import { Search, EyeOff, X, Monitor, Hash, Image, BarChart3, Table, Bell, Volume2, Play, RotateCcw, Info, Ban, Eye, ChevronDown } from 'lucide-react';
...
const TokenRow = React.memo<{
  ...
  }; const secondQuickBuyStyle: CSSVars = {
    '--second-quickbuy-color': displaySettings.secondQuickBuyColor,
  };
