        ...
        >
          <div className="widget-explorer-progress-spacer">
            <div className="widget-explorer-image-wrapper">
              <img src={token.image} alt={token.name} className="widget-explorer-token-image" />
              <div className="widget-explorer-image-overlay">
                <img className="widget-camera-icon" src={camera} alt="inspect" />
              </div>
            </div>
          </div>
            ...
            >
              <div className="widget-explorer-preview-content">
                ...
                <div className="widget-explorer-camera-preview-text">
                  <span className="widget-explorer-token-ticker-preview">{token.symbol}</span>
                  <span className="widget-explorer-token-name-preview">{token.name}</span>
                </div>
              </div>
            </div>,
            document.body
        ...
        <div className="widget-explorer-detail-section">
          ...
          <div className="widget-explorer-second-row">
            <div className="widget-explorer-price-section">
              <span className="widget-explorer-time-created">{formatTimeAgo(token.created)}</span>
            ...
            <div className="widget-explorer-additional-data">
              ...
              <Tooltip content="Pro Traders">
                <div className="widget-explorer-stat-item">
                  ...
                  <span className="widget-explorer-stat-value">{token.proTraders.toLocaleString()}</span>
                </div>
              </Tooltip>
              ...
              <Tooltip content="KOLs">
                <div className="widget-explorer-stat-item">
                  ...
                  <span className="widget-explorer-stat-value">{token.kolTraders.toLocaleString()}</span>
                </div>
              </Tooltip>
            </div>
          </div>
      ...
      <div className="widget-explorer-third-row">
        <Tooltip content="Market Cap">
          <div className="widget-explorer-market-cap">
            ...
            <span className="widget-explorer-market-cap">{formatPrice(token.marketCap)}</span>
          </div>
        </Tooltip>
        ...
        <Tooltip content="Volume">
          <div className="widget-explorer-volume">
            ...
            <span className="widget-mc-value">{formatPrice(token.volume24h)}</span>
          </div>
        </Tooltip>
        ...
        <div className="widget-explorer-third-row-section">
          <Tooltip content="Global Fees Paid">
            <div className="widget-explorer-stat-item">
              ...
              <img className="widget-explorer-fee-icon" src={monadicon} alt="fee" />
              <span className="widget-explorer-fee-total">{token.globalFeesPaid}</span>
            </div>
          </Tooltip>
        ...
        <div className="widget-explorer-actions-section">
          ...
          >
            {isLoading ? (
              ...
              <>
                <img className="widget-explorer-quick-buy-icon" src={lightning} alt="⚡" />
                {quickbuyAmount} MON
              </>
            )}
          </button>
...
const MobileTabSelector: React.FC<MobileTabSelectorProps> = ({ activeTab, onTabChange, tokenCounts }) => {
  const tabs = [
    ...
    <div className="widget-explorer-mobile-tabs">
      {tabs.map((tab) => (
        ...
        >
          ...
          <span className="widget-explorer-mobile-tab-count">({tab.count})</span>
        </button>
      ))}
    </div>
  );
...
const WidgetExplorer: React.FC<WidgetExplorerProps> = ({
  ...
  const [widgetDimensions, setWidgetDimensions] = useState<WidgetDimensions>({ width: 400, height: 700 });
  ...
  const [quickAmounts, setQuickAmounts] = useState<Record<Token['status'], string>>(() => ({
    ...
    graduating: localStorage.getItem('widget-explorer-quickbuy-graduating') ?? '1',
    graduated: localStorage.getItem('widget-explorer-quickbuy-graduated') ?? '1',
  }));
  ...
  const handleMouseMove = useCallback((e: MouseEvent) => {
    ...
    const rightSnapZone = finalX > window.innerWidth - widgetDimensions.width - SNAP_THRESHOLD;
    ...
    />
      ...
      <div className="widget-explorer-header" onMouseDown={handleMouseDown}>
        ...
        <div className="widget-explorer-header-right">
          ...
          <button className="close-btn" onClick={onClose}>
            <img className="widget-explorer-close-icon" src={closebutton} alt="Close" />
          </button>
        </div>
      </div>
      ...
      <div className="widget-explorer-container">
        ...
        <div className="widget-explorer-columns-header">
          <div className={`widget-explorer-column-header ${activeMobileTab === 'new' ? 'active' : ''}`}>
          ...
          <div className={`widget-explorer-column-header ${activeMobileTab === 'graduating' ? 'active' : ''}`}>
            <div className="widget-explorer-column-title-section">
          ...
          <div className={`widget-explorer-column-header ${activeMobileTab === 'graduated' ? 'active' : ''}`}>
            <div className="widget-explorer-column-title-section">
              <h2 className="widget-explorer-column-title">
                Graduated
        ...
        <div className="widget-explorer-columns">
          {/* New Tokens Column */}
          <div className={`widget-explorer-column ${activeMobileTab === 'new' ? 'mobile-active' : ''}`}>
          ...
          <div className={`widget-explorer-column ${activeMobileTab === 'graduating' ? 'mobile-active' : ''}`}>
            <div className="explorer-tokens-list">
              {isLoading ? (
                Array.from({ length: 14 }).map((_, index) => (
          ...
          <div className={`widget-explorer-column ${activeMobileTab === 'graduated' ? 'mobile-active' : ''}`}>
            <div className="explorer-tokens-list">
              {isLoading ? (
                Array.from({ length: 14 }).map((_, index) => (
