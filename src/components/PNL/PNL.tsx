...
import PNLBG from './PNLBG.png';
import PNLBG2_ from './PNLBG2_.png';
...
const PNL: React.FC<PNLProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="pnl-modal-overlay" onClick={onClose}>
      <div 
        className={`pnl-modal-container ${showRightPanel ? 'with-right-panel' : ''} ${isMobile ? 'mobile' : ''}`}
        ...
        <div className="pnl-modal main-popup">
          ...
          <div className="pnl-section pnl-layer-middle">
            <div className="pnl-middle-left">
              ...
              <button
                className="pnl-box"
                onClick={() => handleBgSelect(PNLBG2_)}
                style={{
                  backgroundImage: `url(${PNLBG2_})`,
                  border: selectedBg === PNLBG2_ ? '2px solid white' : '1px solid gray',
                }}
              />
              {uploadedBg && (
                <button
