...
// import { TokenData } from '../TokenExplorer/TokenData';
...
//     // Add the missing props that MemeTradesComponent needs
//     tokenList: any[];
//     marketsData: any[];
...
//     const [activeOrderType, setActiveOrderType] = useState<'market' | 'trigger'>('market');
...
//         const newAmount = (1000 * newPercent) / 100; // Replace 1000 with actual balance
//         setTradeAmount(newAmount.toString());
//     };

//     const { tokenAddress } = useParams<{ tokenAddress: string }>();
//     const token = TokenData.find(t => t.contractAddress === tokenAddress);
...
//     // Time period data - this would normally come from your API
//     const timePeriodsData = {
//         '5M': {
//             change: -0.92,
//             volume: token.volume24h * 0.002, // Simulate 5min volume
//             buyTransactions: Math.floor(token.buyTransactions * 0.001),
//             sellTransactions: Math.floor(token.sellTransactions * 0.001),
//             buyVolumePercentage: 45,
//             sellVolumePercentage: 55,
//             buyerPercentage: 40,
//             sellerPercentage: 60
//         },
//         '1H': {
//             change: 16.42,
//             volume: token.volume24h * 0.05, // Simulate 1hr volume
//             buyTransactions: Math.floor(token.buyTransactions * 0.04),
//             sellTransactions: Math.floor(token.sellTransactions * 0.04),
//             buyVolumePercentage: 75,
//             sellVolumePercentage: 25,
//             buyerPercentage: 80,
//             sellerPercentage: 20
//         },
//         '6H': {
//             change: 18.12,
//             volume: token.volume24h * 0.3, // Simulate 6hr volume
//             buyTransactions: Math.floor(token.buyTransactions * 0.25),
//             sellTransactions: Math.floor(token.sellTransactions * 0.25),
//             buyVolumePercentage: 70,
//             sellVolumePercentage: 30,
//             buyerPercentage: 75,
//             sellerPercentage: 25
//         },
//         '24H': {
...
//     const handleOrderTypeClick = (type: 'market' | 'trigger') => {
//         setActiveOrderType(type);
//         // Clear trigger price when switching to market
//         if (type === 'market') {
//             setTriggerPrice('');
//         }
//     };
...
//         if (activeOrderType === 'trigger' && !triggerPrice) {
//             console.log('Trigger price is required for trigger orders');
//             return;
//         }

//         // Handle trade logic here
//         if (activeOrderType === 'market') {
//             console.log(`${activeTradeType.toUpperCase()} ${tradeAmount} ${token.symbol} at MARKET price`);
//         } else {
//             console.log(`${activeTradeType.toUpperCase()} ${tradeAmount} ${token.symbol} at TRIGGER price ${triggerPrice}`);
//         }
...
//         } else {
//             return `Set ${activeTradeType === 'buy' ? 'Buy' : 'Sell'} Trigger`;
//         }
//     };

//     const isTradeDisabled = () => {
//         if (!tradeAmount) return true;
//         if (activeOrderType === 'trigger' && !triggerPrice) return true;
//         return false;
//     };

//     // Get the current input and conversion currencies based on trade type and input currency
...
//         const baseRate = 0.0045; // 1 MON = 0.0045 TOKEN (example)
//         if (activeTradeType === 'buy') {
//             return inputCurrency === 'MON' ? baseRate : 1 / baseRate;
//         } else {
//             return inputCurrency === 'MON' ? 1 / baseRate : baseRate;
//         }
//     };
...
//         return (parseFloat(tradeAmount) * rate).toFixed(4);
//     };
...
//                 {/* All your existing trade panel JSX */}
...
//                         </button>
//                         <button
//                             className={`meme-order-type-button ${activeOrderType === 'trigger' ? 'active' : 'inactive'}`}
//                             onClick={() => handleOrderTypeClick('trigger')}
//                         >
//                             Trigger
//                         </button>
//                     </div>
...
//                                 ≈ {getConversionAmount()} {getCurrentConversionCurrency()}
//                             </div>
//                         )}
//                     </div>
//                     {activeOrderType === 'trigger' && (
//                         <div className="meme-trade-input-wrapper">
//                             <input
//                                 type="number"
...
//                             <div className="meme-portfolio-value bought">$0</div>
//                         </div>
//                         <div className="meme-portfolio-stat">
//                             <div className="meme-portfolio-label">Sold</div>
//                             <div className="meme-portfolio-value sold">$0</div>
//                         </div>
//                         <div className="meme-portfolio-stat">
//                             <div className="meme-portfolio-label">Holding</div>
//                             <div className="meme-portfolio-value holding">$0</div>
//                         </div>
//                         <div className="meme-portfolio-stat">
//                             <div className="meme-portfolio-label">PnL</div>
//                             <div className="meme-portfolio-value pnl positive">+$0 (+0%)</div>
//                         </div>
//                     </div>
//                 </div>
...
//                                 <div className="meme-stat-value">{formatNumber(totalTransactions)}</div>
//                             </div>
...
//                                 </div>
//                                 <div className="meme-stat-subrow">
//                                     <div className="stat-subvalue buy">{formatNumber(currentData.buyTransactions)}</div>
//                                     <div className="stat-subvalue sell">{formatNumber(currentData.sellTransactions)}</div>
//                                 </div>
...
//                                 <div className="meme-stat-value">{formatNumber(totalTraders)}</div>
//                             </div>
//                             <div className="meme-stat-details">
//                                 <div className="meme-stat-subrow">
...
//                                 </div>
//                                 <div className="meme-stat-subrow">
//                                     <div className="stat-subvalue buy">{formatNumber(buyers)}</div>
//                                     <div className="stat-subvalue sell">{formatNumber(sellers)}</div>
//                                 </div>
//                                 <div className="meme-progress-bar">
//                                     <div
//                                         className="progress-buy"
...
//                                     </svg>
//                                     <span className="meme-token-info-value" style={{ color: token.top10Holding > 5 ? "#eb7070ff" : "rgb(67 254 154)" }}>
...
//                                     </svg>
//                                     <span className="meme-token-info-value" style={{ color: token.devHolding > 5 ? "#eb7070ff" : "rgb(67 254 154)" }}>
...
//                                     </svg>
//                                     <span className="meme-token-info-value" style={{ color: token.sniperHolding > 5 ? "#eb7070ff" : "rgb(67 254 154)" }}>
...
//                                     </svg>
//                                     <span className="meme-token-info-value" style={{ color: token.insiderHolding > 5 ? "#eb7070ff" : "rgb(67 254 154)" }}>
...
//                                     </svg>
//                                     <span className="meme-token-info-value" style={{ color: token.bundleHolding > 5 ? "#eb7070ff" : "rgb(67 254 154)" }}>
//                                         {token.bundleHolding.toFixed(2)}%
//                                     </span>
//                                 </div>
...
//                                     </svg>
//                                     <span className="meme-token-info-value">{token.proTraders.toLocaleString()}</span>
//                                 </div>
...
//                     <span className="meme-address"><img className="meme-contract-icon" src={contract} /><span className="meme-address-title">CA:</span> {token.contractAddress.slice(0, 16)}...{token.contractAddress.slice(-8)}   <svg
...
//                             <path d="M 15 3 C 12.922572 3 11.153936 4.1031436 10.091797 5.7207031 A 1.0001 1.0001 0 0 0 9.7578125 6.0820312 C 9.7292571 6.1334113 9.7125605 6.1900515 9.6855469 6.2421875 C 9.296344 6.1397798 8.9219965 6 8.5 6 C 5.4744232 6 3 8.4744232 3 11.5 C 3 13.614307 4.2415721 15.393735 6 16.308594 L 6 21.832031 A 1.0001 1.0001 0 0 0 6 22.158203 L 6 26 A 1.0001 1.0001 0 0 0 7 27 L 23 27 A 1.0001 1.0001 0 0 0 24 26 L 24 22.167969 A 1.0001 1.0001 0 0 0 24 21.841797 L 24 16.396484 A 1.0001 1.0001 0 0 0 24.314453 16.119141 C 25.901001 15.162328 27 13.483121 27 11.5 C 27 8.4744232 24.525577 6 21.5 6 C 21.050286 6 20.655525 6.1608623 20.238281 6.2636719 C 19.238779 4.3510258 17.304452 3 15 3 z M 15 5 C 16.758645 5 18.218799 6.1321075 18.761719 7.703125 A 1.0001 1.0001 0 0 0 20.105469 8.2929688 C 20.537737 8.1051283 21.005156 8 21.5 8 C 23.444423 8 25 9.5555768 25 11.5 C 25 13.027915 24.025062 14.298882 22.666016 14.78125 A 1.0001 1.0001 0 0 0 22.537109 14.839844 C 22.083853 14.980889 21.600755 15.0333 21.113281 14.978516 A 1.0004637 1.0004637 0 0 0 20.888672 16.966797 C 21.262583 17.008819 21.633549 16.998485 22 16.964844 L 22 21 L 19 21 L 19 20 A 1.0001 1.0001 0 0 0 17.984375 18.986328 A 1.0001 1.0001 0 0 0 17 20 L 17 21 L 13 21 L 13 18 A 1.0001 1.0001 0 0 0 11.984375 16.986328 A 1.0001 1.0001 0 0 0 11 18 L 11 21 L 8 21 L 8 15.724609 A 1.0001 1.0001 0 0 0 7.3339844 14.78125 C 5.9749382 14.298882 5 13.027915 5 11.5 C 5 9.5555768 6.5555768 8 8.5 8 C 8.6977911 8 8.8876373 8.0283871 9.0761719 8.0605469 C 8.9619994 8.7749993 8.9739615 9.5132149 9.1289062 10.242188 A 1.0003803 1.0003803 0 1 0 11.085938 9.8261719 C 10.942494 9.151313 10.98902 8.4619936 11.1875 7.8203125 A 1.0001 1.0001 0 0 0 11.238281 7.703125 C 11.781201 6.1321075 13.241355 5 15 5 z M 8 23 L 11.832031 23 A 1.0001 1.0001 0 0 0 12.158203 23 L 17.832031 23 A 1.0001 1.0001 0 0 0 18.158203 23 L 22 23 L 22 25 L 8 25 L 8 23 z" />
//                         </svg>
//                         <span className="meme-address-title">DA:</span> {token.contractAddress.slice(0, 16)}...{token.contractAddress.slice(-8)}        <a
//                             target="_blank"
